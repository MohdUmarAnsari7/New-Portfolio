...
<a class="navbar-brand" href="index.html">Md Mubashir Khan </a>
...
let footer = $(
`<footer class="footer sticky-bottom" style="background-color:#222; color:#fff; padding: 32px 0;">
  <div class="container text-center">
    <div class="row justify-content-center mb-3">
      <div class="col-12 mb-2">
        <p class="mb-1" style="font-size: 1.2rem; font-weight: 500;">Develop a passion for learning. If you do, you will never cease to grow.</p>
      </div>
      <div class="col-12 mb-3">
        <div class="d-flex justify-content-center align-items-center gap-3" style="gap: 24px;">
          <a class="social-button github" href="https://github.com/786mubashir" target="_blank" title="GitHub">
            <svg class="github-icon-footer" width="36" height="36" viewBox="0 0 300 300">
              <path id="body" d="M112.5,234.4v43.1c24.5,7.5,50.5,7.5,75,0V225c-0.4-11.1-4.9-21.6-12.7-29.6c30-3.4,59.5-23.5,59.5-64.1c0.9-13.9-3.3-27.7-11.8-38.7c4.1-11.6,3.7-24.4-1.3-35.7c0,0-11.2-3.7-37.5,13.8c-22.1-6.1-45.3-6.1-67.4,0C90.6,53.3,78.9,56.8,78.9,56.8c-5,11.3-5.4,24.1-1.3,35.7c-8.5,11.1-12.7,24.8-11.9,38.7c0.2,33.8,26.4,61.8,60.2,64.1c-5,4.7-8.1,11.1-8.6,18" />
              <path id="arm" d="M125.2,213.4c-13.9,7.8-31.5,2.8-39.3-11.2c-4.3-7.7-12-12.8-20.7-13.8c-11.2,0-4.6,6.4,0,9.4c6,5.1,10.8,11.5,13.8,18.8c2.9,7.4,7.7,24.1,41.5,17.8" />
            </svg>
          </a>
          <a class="social-button linkedin" href="https://www.linkedin.com/in/md-mubashir-khan/" target="_blank" title="LinkedIn">
            <svg class="linkedin-icon-footer" xmlns="http://www.w3.org/2000/svg" width="36" viewBox="0 0 24 24" fill="#0e76a8">
              <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path>
              <rect x="2" y="9" width="4" height="12"></rect>
              <circle cx="4" cy="4" r="2"></circle>
            </svg>
          </a>
          <a class="social-button leetcode" href="https://leetcode.com/u/MdMubashirKhan/" target="_blank" title="LeetCode">
            <img src="assets/images/LeetCode.png" alt="LeetCode" width="32" height="32" style="vertical-align:middle;" />
          </a>
        </div>
      </div>
      <div class="col-12">
        <small style="color:#bbb;">&copy; 2024 Md Mubashir Khan &mdash; All Rights Reserved</small>
      </div>
    </div>
  </div>
</footer>`);
